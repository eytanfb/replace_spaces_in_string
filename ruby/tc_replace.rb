...
class TestReplace < Test::Unit::TestCase
  ...
  def test_string_with_not_enough_space_should_raise_not_enough_error_expection
    string = nil
  ...
  def test_get_number_of_words_in_string_should_be_0_if_string_is_empty
    empty_string = "   "
    expected = 0
    actual = Replace.get_number_of_words_in empty_string
    assert_equal expected, actual
  end
  
  def test_get_number_of_words_in_string
    string = "a   "
    expected = 1
    actual = Replace.get_number_of_words_in string
    assert_equal expected, actual
